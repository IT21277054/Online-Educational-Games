...
<div class="Rtitle">Delete My Review</div>
...
<div class="Rcontent">
    ...
    <fieldset>
        <legend>Delete My Review</legend>
        
    

    <form action="" method="POST">
        <input type="text" id = "reviewSubject" name = "Topic" value ="<?php echo $Topic; ?>" readonly><br>


        <textarea type="text" id = "reviewbox" name = "Content"readonly><?php echo $Content; ?></textarea><br>


    <!-- Add stars -->
    <div class="star-rating">
        <input type="radio" name="stars" id="star-a" value="5"disabled/>
        <label for="star-a"></label>
        
        <input type="radio" name="stars" id="star-b" value="4"disabled/>
        <label for="star-b"></label>
        
        <input type="radio" name="stars" id="star-c" value="3"disabled/>
        <label for="star-c"></label>
        
        <input type="radio" name="stars" id="star-d" value="2"disabled/>
        <label for="star-d"></label>
        
        <input type="radio" name="stars" id="star-e" value="1"disabled/>
    ...
    <div class = "Button">
        ...
        <button type = "submit" name="submit" class="AddReviewButton">Delete review</button>
